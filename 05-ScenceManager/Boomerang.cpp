...
void CBoomerang::Render(){
	...
	animation_set->at(BOOMERANG_ANI_ATK_RIGHT)->Render(x, y);
	// if(state == BOOMERANG_STATE_RIGHT){
	// 	animation_set->at(BOOMERANG_ANI_ATK_RIGHT)->Render(x, y);
	// }else if(state == BOOMERANG_STATE_LEFT){
	// 	animation_set->at(BOOMERANG_ANI_ATK_LEFT)->Render(x, y);
	// }else if(state == BOOMERANG_STATE_DISAPPEAR){
	// 	animation_set->at(BOOMERANG_ANI_ATK_RIGHT)->Render(10000, 10000);
	// 	animation_set->at(BOOMERANG_ANI_ATK_LEFT)->Render(10000, 10000);
	// }
}
